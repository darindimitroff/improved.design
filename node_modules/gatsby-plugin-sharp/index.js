...
var responsiveSizes = function () {
  var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(_ref8) {
    ...
    var defaultArgs, options, sizes, dimensions, filteredSizes, sortedSizes, images, base64Args, base64Image, originalImg, fallbackSrc, srcSet, originalName;
...
var responsiveResolution = function () {
  ...
  return function responsiveResolution(_x5) {
...
function queueImageResizing(_ref2) {
  ...
  var imgSrc = `/${file.internal.contentDigest}-${argsDigestShort}.${fileExtension}`;
