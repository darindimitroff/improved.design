...
var _gatsby1ConfigCssModules2 = _interopRequireDefault(_gatsby1ConfigCssModules);
              ...
              switch (stage) {
                case `develop`:
                  ...
                  config.loader(`cssModules`, {
                    test: /\.module\.css$/,
                    loaders: [`style`, (0, _gatsby1ConfigCssModules2.default)(stage), `postcss`]
                  });
                ...
                case `build-css`:
                  ...
                  config.loader(`cssModules`, {
                    test: /\.module\.css$/,
                    loader: _extractTextWebpackPlugin2.default.extract(`style`, [(0, _gatsby1ConfigCssModules2.default)(stage), `postcss`])
                  });
                  config.merge({
                ...
                case `build-javascript`:
                  {
                    ...
                    new _webpack2.default.optimize.CommonsChunkPlugin({
                      ...
                      minChunks: function minChunks(module, count) {
                        var vendorModuleList = [`react`, `react-dom`, `fbjs`, `react-router`, `react-router-dom`, `react-router-scroll`, `dom-helpers`, // Used in react-router-scroll
